			...
			<div className="d-flex justify-content-center pt-5">
				...
				<div className="card" style={{ "width": "18rem;" }}>
					<ul className="list-group list-group-flush">
						...
						<li className="single3 list-group-item"><p className="fw-bold">Origin: {store.personaje.origin?.name}</p></li>
					</ul>
					<div className=" d-flex justify-content-center pb-2 pt-2">
						<button className="btn btn-info" onClick={()=> actions.addtoFavorites(store.personaje.name)}>Add to Favorites</button>
					</div>
				</div>
